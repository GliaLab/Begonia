    ...
    methods
        function self = h5arr(varargin)
            ...
            if isempty(self.dim)
                ...
                h5create(self.filename,'/dataset_1',self.dim, 'Datatype', in.datatype)
            end
        end
        ...
        function self = subsasgn(self, s, data)
            ...
            h5write(self.filename,'/dataset_1',data,start,count,stride)
        end
        ...
        function out = subsref(self, s)
            ...
            [start, count, stride] = self.get_scs(s);
            out = h5read(self.filename,'/dataset_1',start,count,stride);
